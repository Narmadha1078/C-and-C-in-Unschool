...
int order ()
{
    ...
    p[order_count].Order_No = 10000+order_count;
    items();
    p[order_count].No_of_food = n;
    p[order_count].cost = 0;
    p[order_count].No_of_food = 0;
    ...
    case 11 :
    {
        printf ("Enter the size of fried chicken: 1. 100gm  2. 200gm\n");
        int i;
        scanf ("%d", &i);
        getchar();
...
int receive ()
{
    ...
    printf ("Order no. %d by %s is ready\n", p[served_count].Order_No, p[served_count].Name);
...
void items ()
{
    ...
    printf("[11]---------Fried chicken Burger-------100/200gm------------------130/180\n");
...
int main ()
{
    ...
    while (1){
        ...
        switch (in){
            ...
            case 4 :
            {
                printf ("Closed. But def for tomorrow. Have a nice day. \n\n");
